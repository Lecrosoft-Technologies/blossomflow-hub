  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-subtle">
      ...
      <div className="absolute inset-0">
        ...
        <div 
          ref={parallaxRef}
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-20 parallax-element"
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-40 right-20 w-48 h-48 bg-blossom-pink/20 rounded-full blur-3xl animate-float parallax-medium" style={{ animationDelay: '2s' }} />
          <div className="absolute bottom-20 left-1/4 w-40 h-40 bg-blossom-coral/20 rounded-full blur-3xl animate-float parallax-fast" style={{ animationDelay: '4s' }} />
          <div className="absolute bottom-40 right-10 w-24 h-24 bg-blossom-mint/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto animate-fade-in-up stagger-4">
            <div className="glass-card text-center p-8 group hover-lift">
              ...
              <h3 className="text-xl font-heading font-bold mb-3 text-foreground">High-Energy Zumba</h3>
              <p className="text-muted-foreground">Dance-fitness classes that combine Latin rhythms with effective cardio workouts</p>
            </div>
            ...
            <div className="glass-card text-center p-8 group hover-lift">
              ...
              <h3 className="text-xl font-heading font-bold mb-3 text-foreground">Premium Wellness</h3>
              <p className="text-muted-foreground">Holistic approach including nutrition guidance and lifestyle coaching</p>
            </div>
            ...
            <div className="glass-card text-center p-8 group hover-lift">
              ...
              <h3 className="text-xl font-heading font-bold mb-3 text-foreground">Vibrant Community</h3>
              <p className="text-muted-foreground">Connect with like-minded fitness enthusiasts across Nigeria</p>
            </div>
          </div>
