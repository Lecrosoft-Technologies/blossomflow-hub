        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in-up stagger-2">
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-[15%] -left-8 glass-card p-4 rounded-xl shadow-lg animate-float">
              ...
              <div className="hidden lg:block absolute top-[35%] -right-4 glass-card p-4 rounded-xl shadow-lg animate-float" style={{ animationDelay: "0.5s" }}>
                <div className="text-3xl font-heading font-bold bg-gradient-primary bg-clip-text text-transparent">
                  50+
                </div>
                <div className="text-sm text-muted-foreground font-medium whitespace-nowrap">
              ...
              <div className="hidden lg:block absolute bottom-[30%] -left-12 glass-card p-4 rounded-xl shadow-lg animate-float" style={{ animationDelay: "1s" }}>
                <div className="text-3xl font-heading font-bold bg-gradient-primary bg-clip-text text-transparent">
                  5+
                </div>
                <div className="text-sm text-muted-foreground font-medium whitespace-nowrap">
              ...
              <div className="hidden lg:block absolute bottom-[10%] right-0 glass-card p-4 rounded-xl shadow-lg animate-float" style={{ animationDelay: "1.5s" }}>
                <div className="text-3xl font-heading font-bold bg-gradient-primary bg-clip-text text-transparent">
                  100%
                </div>
                <div className="text-sm text-muted-foreground font-medium whitespace-nowrap">
