        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Ready to start your fitness journey? Have questions about our
              classes or products? We're here to help you every step of the way.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-8">
                ...
                {/* <div className="card-glass p-8 border border-primary/20 text-center bg-gradient-primary/5">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Join our team of passionate fitness professionals and help
                    transform lives. We're always looking for certified trainers
                ...
                <div className="card-glass p-8 border border-cyber-blue/20 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    For urgent matters or technical support, reach out to us
                    directly.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button
                      variant="outline"
                      className="border-cyber-blue/50 hover:bg-cyber-blue/10 flex-1"
                    >
                      Live Chat
                    </Button>
                    <Button
                      variant="outline"
                      className="border-energy-green/50 hover:bg-energy-green/10 flex-1"
                    >
                      WhatsApp
                    </Button>
                  </div>
